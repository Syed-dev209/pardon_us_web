...
class LargeClassScreen extends StatefulWidget {
  @override
  _LargeClassScreenState createState() => _LargeClassScreenState();
}

class _LargeClassScreenState extends State<LargeClassScreen> {
  String name;
  @override
