                                    ...
                                    child: RaisedButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (
                                          ...
                                          final check =
                                              await directory.pickFiles();
                                          _file = check;
                                          html.File received =
                                              html.File(check.bytes, check.name);
                                          print(received.name);
                                          // print(htmlFile.type);
                                          // print(htmlFile.relativePath);
                                          setState(() {
                                            htmlFile = received;
                                            if (htmlFile != null) {
                                              fileSelected = true;
                            ...
                            Container(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  try {
                                    String fileUrl = await upload.uploadFileWeb(
                                        _file,
                                        Provider.of<UserDetails>(context,
                                                listen: false)
                                            .currentClassCode,'quizFiles');
                                    bool check = await upload.uploadDetails(
                                        quizTitle.text,
                                        _time.toString(),
                                        _date.toString(),
                                        fileUrl,
                                    ...
                                    if (check) {
                                      ...
                                      _onButtonAlertPressed(context, 'WOOHO !',
                                          'Quiz uploaded successfully ');
                                    } else {
                                      _onBasicAlertPressed(context, 'FAILED',
