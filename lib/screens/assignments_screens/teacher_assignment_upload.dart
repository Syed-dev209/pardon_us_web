                    ...
                    Container(
                      ...
                      child: RaisedButton(
                        ...
                        child: Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Expanded(child: Icon(Icons.date_range,color: Colors.white,)),
                            SizedBox(width: 7.0,),
                            Expanded(
                              flex: 3,
                              child: Text('Choose submission date',
                                style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 14.0
                                ),),
                    ...
                    Container(
                      ...
                      child: RaisedButton(
                        ...
                        child: Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Expanded(child: Icon(Icons.timer,color: Colors.white,)),
                            SizedBox(width: 7.0,),
                            Expanded(
                              flex: 3,
                              child: Text('Choose submission time',
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 14.0
                                  )),
                              ...
                              child: RaisedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  isTimeSelected &&
                                    ...
                                    htmlFile=html.File(_file.bytes,_file.name);
                                    print(_file.name);
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: ()async{
                          try{
                            ...
                            String fileUrl=await upload.uploadFileWeb(_file, Provider
