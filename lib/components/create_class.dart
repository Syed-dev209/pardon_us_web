                  ...
                  try{
                    if(_key.currentState.validate()) {
                      ...
                      if (joined == 'enter') {
                        ...
                        _onBasicAlertPressed(context, 'Invalid Registration', 'You hav already registered in this class.');


                      }
                      else if(joined=='Teacher'){
                       _onBasicAlertPressed(context, 'Invalid Registration', 'You can not join the class you created.');

                      }
                      else{
                       _onBasicAlertPressed(context, 'Invalid Class Code', 'This class does not exist.');
